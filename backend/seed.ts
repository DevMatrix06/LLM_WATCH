...
// Run from the backend directory: npx tsx seed.ts
...
const LOGS = [
  ...
  {
    timestamp:     new Date('2026-06-03T22:10:00Z'),
    model:         'claude-sonnet-4-6',
    prompt:        'Summarize the key changes in the EU AI Act for a non-technical audience.',
    completion:    '',
    latency_ms:    340,
    input_tokens:  0,
    output_tokens: 0,
    ...
    error_message: 'Rate limit exceeded, please retry after 60s',
    project_id:    'proj-web',
    user_id:       'user-1',
    session_id:    'sess-a4',
    tags:          [],
